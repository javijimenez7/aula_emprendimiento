...
/* inject Js and CCS front into HTML */
gulp.task('injectCommonfront', function () {
...
gulp.task('inject', gulp.series('injectPartial' , 'injectCommonfront' , 'injectLayoutStyles', 'replacePath'));
...
gulp.task('copyAddonsScripts', function() {
    ...
    var aScript23 = gulp.src(['node_modules/pwstabs/front/jquery.pwstabs.min.js'])
...
gulp.task('copyAddonsStyles', function() {
    ...
    var aStyle54 = gulp.src(['node_modules/pwstabs/front/jquery.pwstabs.min.css'])
        .pipe(gulp.dest('./vendors/pwstabs'));
